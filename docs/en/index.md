...
An integrated introduction to specification, model checking, theorem proving, and program verification.

> Translation status: skeleton  
> Japanese source of truth: `src/ja/index.md`

This landing page keeps the English edition publishable at `/en/` while the full translation is prepared.

## Reading Guide

- Start with [Introduction]({{ '/en/introduction/' | relative_url }}) if you are new to formal methods.
- Use the English table of contents below to keep a one-to-one correspondence with the Japanese edition.
- Refer to the [Glossary]({{ '/en/glossary/' | relative_url }}) for core terms and abbreviations.
...
- Status: skeleton
- Source of truth: `src/ja/index.md`
- Next step: replace each placeholder page with a translated chapter while preserving the same structure and identifiers.
