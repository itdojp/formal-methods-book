...
translation_source_commit: "88e9512b3af9d1a08184fa4a78edca2405e94636"
...
> **Translation status: Partial.** Reviewed against Japanese source commit [`88e9512b3af9`](https://github.com/itdojp/formal-methods-book/commit/88e9512b3af9d1a08184fa4a78edca2405e94636) on 2026-07-19.
...
- `tlc-queue-bounded`: canonical assets [examples/tla/QueueBounded.tla](https://github.com/itdojp/formal-methods-book/blob/{{site.github.build_revision|default:'main'}}/examples/tla/QueueBounded.tla) and [examples/tla/QueueBounded.cfg](https://github.com/itdojp/formal-methods-book/blob/{{site.github.build_revision|default:'main'}}/examples/tla/QueueBounded.cfg); lane `pr-quick`; pinned version `TLC 1.7.4`; expected success marker `Model checking completed. No error has been found.`. Retrieve both the specification and its `.cfg` from the same repository revision.
...
- `apalache-counter`: canonical assets [examples/apalache/Counter.tla](https://github.com/itdojp/formal-methods-book/blob/{{site.github.build_revision|default:'main'}}/examples/apalache/Counter.tla) and [examples/apalache/Counter.cfg](https://github.com/itdojp/formal-methods-book/blob/{{site.github.build_revision|default:'main'}}/examples/apalache/Counter.cfg); lane `pr-quick`; pinned version `Apalache 0.52.1`; expected success marker `Checker reports no error up to computation length 10`. Retrieve the whole `examples/apalache/` pair from the same commit instead of copying the inline sketch alone.
