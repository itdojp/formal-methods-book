...
<span id="glossary-alethe" class="search-term-anchor" aria-hidden="true"></span>**Alethe**: An SMT proof-certificate format in the SMT-LIB ecosystem. It is
...
<span id="glossary-drat" class="search-term-anchor" aria-hidden="true"></span>**DRAT**: A clausal proof ecosystem for showing `unsat` of propositional CNF.
...
<span id="glossary-lfsc" class="search-term-anchor" aria-hidden="true"></span>**LFSC**: A proof format and checking framework based on the LF logical
...
<span id="glossary-lrat" class="search-term-anchor" aria-hidden="true"></span>**LRAT**: A propositional-CNF `unsat` certificate format designed to carry more
...
<span id="glossary-model--witness" class="search-term-anchor" aria-hidden="true"></span>**Model / witness**: A concrete satisfying assignment or execution returned by
...
<span id="glossary-proof-certificate" class="search-term-anchor" aria-hidden="true"></span>**Proof certificate**: A machine-readable artifact emitted so that an `unsat`
...
<span id="glossary-proof-checker" class="search-term-anchor" aria-hidden="true"></span>**Proof checker**: A checker or kernel that mechanically validates a proof
