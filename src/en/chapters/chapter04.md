...
- `alloy-collection`: canonical asset [examples/alloy/collection.als](../../../examples/alloy/collection.als); lane `pr-quick`; pinned version `Alloy 6.2.0`; expected success marker `Alloy exec: examples/alloy/collection.als`; `run$1-solution-0.md` is also generated as an execution artifact. Retrieve [examples/alloy/collection.als](../../../examples/alloy/collection.als) from the same commit as the manuscript.
...
- `alloy-university-enrollment`: canonical asset [examples/ch04/university-enrollment.als](../../../examples/ch04/university-enrollment.als); lane `pr-quick`; pinned version `Alloy 6.2.0`; expected success marker `Alloy exec: examples/ch04/university-enrollment.als`; `run$1-solution-0.md` is also generated as an execution artifact. Retrieve the self-contained file from [examples/ch04/university-enrollment.als](../../../examples/ch04/university-enrollment.als) in the same revision.
...
- `alloy-leader-election`: canonical asset [examples/ch04/leader-election.als](../../../examples/ch04/leader-election.als); lane `pr-quick`; pinned version `Alloy 6.2.0`; expected success marker `Alloy exec: examples/ch04/leader-election.als`; the three solution files are also generated as execution artifacts. Retrieve the shared JA/EN source file from [examples/ch04/leader-election.als](../../../examples/ch04/leader-election.als).
