...
- `spin-ltl-properties`: canonical asset [examples/ch08/spin/ltl-properties.pml](../../../examples/ch08/spin/ltl-properties.pml); lane `nightly`; pinned version `SPIN 6.5.2`; expected success marker `errors: 0`. Retrieve [examples/ch08/spin/ltl-properties.pml](../../../examples/ch08/spin/ltl-properties.pml) from the same commit as the manuscript.
...
- `spin-producer-consumer`: canonical asset [examples/ch08/spin/producer-consumer.pml](../../../examples/ch08/spin/producer-consumer.pml); lane `nightly`; pinned version `SPIN 6.5.2`; expected success marker `errors: 0`. Retrieve the self-contained Promela source from [examples/ch08/spin/producer-consumer.pml](../../../examples/ch08/spin/producer-consumer.pml) in the same revision.
...
- `nusmv-fairness`: canonical asset [examples/ch08/nusmv/fairness.smv](../../../examples/ch08/nusmv/fairness.smv); lane `nightly`; pinned version `NuSMV 2.7.1`; expected success marker `-- is true`. Retrieve the shared JA/EN asset from [examples/ch08/nusmv/fairness.smv](../../../examples/ch08/nusmv/fairness.smv).
...
- `nusmv-request-response`: canonical asset [examples/ch08/nusmv/request-response.smv](../../../examples/ch08/nusmv/request-response.smv); lane `nightly`; pinned version `NuSMV 2.7.1`; expected result `-- is false`, representing the intentional counterexample while the NuSMV process itself exits successfully. Retrieve [examples/ch08/nusmv/request-response.smv](../../../examples/ch08/nusmv/request-response.smv) from the same repository revision.
...
- `cbmc-array-bounds`: canonical asset [examples/ch08/cbmc/array-bounds.c](../../../examples/ch08/cbmc/array-bounds.c); lane `nightly`; pinned version `CBMC 6.10.0`; expected success marker `VERIFICATION SUCCESSFUL`. Retrieve the full source file from [examples/ch08/cbmc/array-bounds.c](../../../examples/ch08/cbmc/array-bounds.c) instead of copying the inline excerpt alone.
