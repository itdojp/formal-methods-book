...
- `src/en/appendices/appendix-c.md`
- `src/en/appendices/appendix-d.md`
- `src/en/appendices/appendix-e.md`
- `src/en/appendices/appendix-f.md`

If future appendix-draft work is needed in English, add it here deliberately
instead of treating this file as an automatically translated duplicate of the
Japanese draft bundle.
