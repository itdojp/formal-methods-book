...
![図5-1: Z記法のスキーマ構造と状態ベース仕様記述](../../docs/assets/images/diagrams/z-notation-schema-structure.svg)

人間の認知能力には限界があります。しばしば引用される目安として、人間が同時に把握できる概念の数は7±2個程度とされます。しかし、現実のソフトウェアシステムには、数十から数百の要素が存在します。スキーマは、この認知限界を克服するための抽象化メカニズムなのです。
