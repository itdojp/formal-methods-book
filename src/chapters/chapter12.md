...
AI支援のワークフローやテンプレートの詳細な実践テンプレートとプロンプト例については、付録Fを参照してください。
