...
![図2-2：主要な形式的手法の比較マトリクス](../../../docs/assets/images/diagrams/formal-methods-comparison-matrix.svg)
...
![図2-3: 状態遷移モデル（銀行口座システムの例）](../../../docs/assets/images/diagrams/state-transition-model.svg)
